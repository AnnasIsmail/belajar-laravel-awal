...
<main class="main-my-community">
  ...
  <div class="card" style="width: 18rem;">
      <div class="card-body">
        <h5 class="card-title">{{ $data["RiotId"] }}#{{ $data["Tagline"] }} <a href="/update-account{{ $data["Username"] }}"><ion-icon data-bs-toggle="tooltip" title="Edit Account" name="create-outline"></ion-icon></a> </h5>
